        ...
        const DAILY_120_125_COMBO45_OPENING1_SEED_POOL = [1445,23547,141302,165073,221378,277611,327321,489006,502970,511529,516736,542326,571840,604281,705752,706772,813549,921155,931442,982379,1053309,1116000,1181307,1192915,1319864,1337270,1373844,1414716,1450159,1539952,1592732,1658116,1701700,1758068,2020825,2021112,2044907,2114374,2128572,2162981,2173593,2183649,2224818,2284186,2417907,2462071,2484777,2510094,2534318,2630783,2671818,2777355,2808090,2815485,2829789,2878723,2882133,2902267,2952612,3038457,3068892,3126887,3189281,3262711,3287506,3360513,3463475,3489181,3526188,3585282,3687768,3760019,3763111,3784056,3881274,3891516,3931183,3950789,3952374,3990716,4021799,4024012,4159393,4159766,4251372,4253426,4312355,4383528,4384178,4391625,4454280,4521484,4527628,4532763,4539498,4630796,4640465,4646236,4681921,4773675,4780997,4820563,4867146,4936660,4986320,5090167,5369326,5379905,5423023,5492299,5495910,5513925,5558601,5624475,5635435,5730352,5810000,5849924,5850261,5865293,6078138,6080742,6085690,6161943,6199901,6204920,6293349,6380002,6396705,6415365,6514312,6575152,6578295,6627224,6668176,6703760,6714570,6751110,6871216,6882322,6947856,6967339,7035314,7043892,7058575,7095637,7122464,7177525,7179161,7260956,7278667,7280502,7402018,7472736,7484567,7514077,7556849,7591756,7602894,7617055,7672220,7675117,7693122,7711597,7737765,7742478,7751844,7786630,7808069,7809459,7832188,7923223,7955253,7984273,8091709,8143188,8147526,8263053,8358844,8366868,8403055,8411528,8462771,8543126,8563013,8719409,8758182,8763505,8779674,8781236,8805240,8843991,8856714,8864833,8876594,8894953,8936438,9031521,9035210,9252012,9269758,9403091,9437225,9540199,9585819,9601983,9628206,9646831,9656842,9795552,9865029,9910685,9971155,9977316,10050444,10058337,10075390,10173423,10232125,10342360,10491799,10510706,10519550,10690029,10701094,10729045,10729462,10775839,10805285,10853471,10879189,10924974,10932026,10954636,10954835,11029643,11030207,11055290,11117702,11124524,11167400,11177751,11242851,11267190,11346460,11370148,11398800,11400619,11411470,11552860];
        ...
        const G15_BRIDGE_SEED_POOL = DAILY_120_125_COMBO45_OPENING1_SEED_POOL;
        ...
        let predictionSuit = '';
        let predictionAutoPicked = false;
        let predictionResolved = false;
        let predictionRelayoutHandler = null;
        let predictionNudgeTimer = null;
        ...
        function buildDailyTierPools() {
            ...
            const dailyPool = nonEmpty(DAILY_120_125_COMBO45_OPENING1_SEED_POOL)
                ? DAILY_120_125_COMBO45_OPENING1_SEED_POOL
                : T4_FLOW_SEED_POOL;
            return {
                easy: dailyPool,
                normal: dailyPool,
        ...
        function clearPredictionUi() {
            document.getElementById('prediction-overlay')?.remove();
            document.getElementById('prediction-badge')?.remove();
            if (predictionRelayoutHandler) {
                window.removeEventListener('resize', predictionRelayoutHandler);
                predictionRelayoutHandler = null;
            }
            if (predictionNudgeTimer) {
                clearTimeout(predictionNudgeTimer);
                predictionNudgeTimer = null;
            }
        }

        function updatePredictionBadge() {
            let badge = document.getElementById('prediction-badge');
            if (!predictionSuit) {
            ...
            if (!badge) {
                ...
                badge.id = 'prediction-badge';
                badge.className = 'prediction-badge';
                document.body.appendChild(badge);
            }
            badge.textContent = `${t('prediction.badge')}: ${predictionSuit} · ${predictionAutoPicked ? t('prediction.auto') : t('prediction.you')}`;
        }

        function lockPredictionPick(chosenSuit, { auto = false } = {}) {
            if (predictionResolved) return;
            if (!PREDICTION_SUITS.includes(chosenSuit)) return;
            predictionSuit = chosenSuit;
            predictionAutoPicked = !!auto;
            ...
            setTimeout(() => overlay?.remove(), getDelay(260));
        }

        function ensurePredictionPicked(reason = 'auto') {
            if (predictionResolved || tutorialDeckMode) return;
            const pick = PREDICTION_SUITS[Math.floor(Math.random() * PREDICTION_SUITS.length)];
            lockPredictionPick(pick, { auto: true });
            if (reason === 'deal' || reason === 'clear') updatePredictionBadge();
        }

        function showPredictionOverlay() {
            if (tutorialDeckMode || hasWon) return;
            document.getElementById('prediction-overlay')?.remove();
            const layoutSuits = PREDICTION_SUITS.slice();
            for (let i = layoutSuits.length - 1; i > 0; i--) {
                const j = Math.floor(Math.random() * (i + 1));
                [layoutSuits[i], layoutSuits[j]] = [layoutSuits[j], layoutSuits[i]];
            }
            const overlay = document.createElement('div');
            overlay.id = 'prediction-overlay';
            overlay.className = 'prediction-overlay';
            overlay.innerHTML = `
                <div class="prediction-title">${t('prediction.title')}</div>
                <div class="prediction-hint">${t('prediction.hint')}</div>
                <div class="prediction-row">
                    ${layoutSuits.map((s) => `
                        <button type="button" class="prediction-card" data-suit="${s}">
                            <span class="prediction-face prediction-back"></span>
                            <span class="prediction-face prediction-front">
            ...
            const row = overlay.querySelector('.prediction-row');
            const relayout = () => {
                const footerH = document.getElementById('footer')?.offsetHeight || 96;
                const floorTop = window.innerHeight - footerH - 104;
                const cards = Array.from(overlay.querySelectorAll('.prediction-card'));
                cards.forEach((btn, i) => {
                    const col = document.getElementById(`col-${i}`);
                    if (!col) return;
                    const r = col.getBoundingClientRect();
                    const x = r.left + r.width / 2 - 34;
                    const y = Math.min(floorTop, r.bottom - 98);
                    btn.style.left = `${Math.round(x)}px`;
                    btn.style.top = `${Math.round(Math.max(72, y))}px`;
                    btn.style.animationDelay = `${i * 90}ms`;
                });
                if (row) row.style.height = `${Math.max(104, floorTop - 56)}px`;
            };
            relayout();
            predictionRelayoutHandler = relayout;
            window.addEventListener('resize', relayout);
            overlay.querySelectorAll('.prediction-card').forEach((btn, idx) => {
                btn.addEventListener('click', () => lockPredictionPick(btn.dataset.suit || ''), { once: true });
                setTimeout(() => btn.classList.add('revealed'), getDelay(120 + idx * 90));
            });
            predictionNudgeTimer = setTimeout(() => {
                if (predictionResolved) return;
                overlay.classList.add('nudge');
                setTimeout(() => overlay.classList.remove('nudge'), getDelay(900));
            }, getDelay(2000));
        }

        function resetPredictionState() {
            predictionSuit = '';
            predictionAutoPicked = false;
            predictionResolved = false;
            clearPredictionUi();
        }

        function showPredictionHitFX(suit) {
            const sym = SUIT_SYMBOLS[suit] || '✦';
            const color = SUIT_COLORS[suit] || '#ffd86d';
            const root = document.createElement('div');
            root.className = 'prediction-hit-fx';
            root.innerHTML = `
                <div class="prediction-hit-core" style="--hit-color:${color}">${sym}</div>
                ${Array.from({ length: 8 }).map((_, i) => `
                    <div class="prediction-hit-symbol" style="--hit-color:${color};--a:${i * 45}deg;--d:${56 + (i % 2) * 16}px;--delay:${i * 26}ms">${sym}</div>
                `).join('')}
            `;
            document.body.appendChild(root);
            setTimeout(() => root.remove(), getDelay(980));
        }

        // --- 3. 連擊靈獸浮現 ---
        const SPIRIT_BEASTS = {
            2: { cls: 'tier-2', icon: 'comboicon/fox.png' },
            3: { cls: 'tier-3', icon: 'comboicon/pixiu.png' },
            4: { cls: 'tier-4', icon: 'comboicon/tiger.png' },
            5: { cls: 'tier-5', icon: 'comboicon/zhuque.png' },
            6: { cls: 'tier-6', icon: 'comboicon/dragon.png' },
            7: { cls: 'tier-7', icon: 'comboicon/xuanwu.png' },
            8: { cls: 'tier-8', icon: 'comboicon/qilin.png' },
            9: { cls: 'tier-9', icon: 'comboicon/imperial.png' },
        };
        ...
        function showSpiritBeast(tier) {
            ...
            if (tier === 2) {
                ...
                el.className = 'spirit-beast spirit-pixiu';
                el.innerHTML = `<img class="spirit-beast-icon" src="${meta.icon}" alt="" />`;
                document.body.appendChild(el);
                setTimeout(() => el.remove(), getDelay(2400));
            } else if (tier === 4) {
                el.className = 'spirit-beast spirit-tiger';
                el.innerHTML = `<img class="spirit-beast-icon" src="${meta.icon}" alt="" />`;
                document.body.appendChild(el);
                setTimeout(() => {
                ...
                el.className = 'spirit-beast spirit-zhuque';
                el.innerHTML = `<img class="spirit-beast-icon" src="${meta.icon}" alt="" />`;
                document.body.appendChild(el);
                setTimeout(() => {
                    const wave = document.createElement('div');
                ...
                el.className = 'spirit-beast spirit-dragon';
                el.innerHTML = `<img class="spirit-beast-icon" src="${meta.icon}" alt="" />`;
                document.body.appendChild(el);
                setTimeout(() => {
                    const wave = document.createElement('div');
                    wave.className = 'dragon-coil-wave';
                    document.body.appendChild(wave);
                    setTimeout(() => wave.remove(), getDelay(900));
                }, getDelay(500));
                setTimeout(() => el.remove(), getDelay(3200));
            } else if (tier === 7) {
                el.className = 'spirit-beast spirit-xuanwu';
                el.innerHTML = `<img class="spirit-beast-icon" src="${meta.icon}" alt="" />`;
                document.body.appendChild(el);
                setTimeout(() => {
                    document.body.classList.add('xuanwu-quake');
                    setTimeout(() => document.body.classList.remove('xuanwu-quake'), getDelay(700));
                    const wave = document.createElement('div');
                    wave.className = 'xuanwu-ground-wave';
                    document.body.appendChild(wave);
                    setTimeout(() => wave.remove(), getDelay(1000));
                }, getDelay(700));
                setTimeout(() => el.remove(), getDelay(3800));
            } else if (tier === 8) {
                el.className = 'spirit-beast spirit-qilin';
                el.innerHTML = `<img class="spirit-beast-icon" src="${meta.icon}" alt="" />`;
                document.body.appendChild(el);
                setTimeout(() => {
                    const flare = document.createElement('div');
                    flare.className = 'qilin-sacred-light';
                    document.body.appendChild(flare);
                    setTimeout(() => flare.remove(), getDelay(1400));
                }, getDelay(350));
                setTimeout(() => el.remove(), getDelay(3800));
            } else if (tier === 9) {
                el.className = 'spirit-beast spirit-imperial';
                el.innerHTML = `<img class="spirit-beast-icon" src="${meta.icon}" alt="" />`;
                document.body.appendChild(el);
                setTimeout(() => {
                    const burst = document.createElement('div');
                    burst.className = 'imperial-golden-burst';
                    document.body.appendChild(burst);
                    setTimeout(() => burst.remove(), getDelay(1600));
                    document.body.classList.add('imperial-quake');
                    setTimeout(() => document.body.classList.remove('imperial-quake'), getDelay(900));
                }, getDelay(350));
                setTimeout(() => el.remove(), getDelay(4200));
            }
        }
        ...
        function syncBoardScale() {
            ...
            // Dynamic stack spacing: grow with corner text scale to avoid clipping.
        ...
        function onWinDropFragment(multiplier = 1) {
            ...
            state.pityNoDrop = 0;
            const dropTimes = Math.max(1, Math.floor(multiplier));
            const results = [];
            for (let i = 0; i < dropTimes; i++) {
                const thisCandidate = i === 0 ? candidate : pickDropCandidate(state);
                if (!thisCandidate) continue;
                results.push(applyDropToState(state, thisCandidate));
            }
            saveGalleryState(state);
            results.forEach((result, idx) => {
                setTimeout(() => showFragmentToast(result), idx * getDelay(220));
            });
            updateFocusWidget();
        ...
        const CARDBACK_REGISTRY = {
            classic: buildCardbackConfig('./cardback/classic.webp', 'CRYSTAL', 'rgba(255, 215, 0, 0.9)', 'CRYSTAL'),
            classic_blue: buildCardbackConfig('./cardback/classic.webp', 'CRYSTAL', 'rgba(100, 180, 255, 0.9)', 'CRYSTAL'),
            classic_red: buildCardbackConfig('./cardback/classic.webp', 'CRYSTAL', 'rgba(255, 100, 120, 0.9)', 'CRYSTAL'),
            retro_gold: buildCardbackConfig('./cardback/lucky3_retro_classic_gold.webp', 'FORGE_GOLD', 'rgba(218, 165, 32, 1)', 'FORGE'),
            nightgold: buildCardbackConfig('./cardback/nightgold.webp', 'EMBER_DARK', 'rgba(218, 165, 32, 0.95)', 'FORGE'),
            forest: buildCardbackConfig('./cardback/forest.webp', 'LIFE_FOREST', 'rgba(60, 220, 80, 0.85)', 'LIFE'),
            crimson: buildCardbackConfig('./cardback/crimson.webp', 'EMBER_BRIGHT', 'rgba(255, 60, 40, 0.9)', 'FORGE'),
            void: buildCardbackConfig('./cardback/void.webp', 'VOID_PURPLE', 'rgba(180, 120, 255, 0.9)', 'VOID'),
            lucky: buildCardbackConfig('./cardback/lucky.webp', 'LIFE_FESTIVE', 'rgba(255, 215, 0, 0.9)', 'LIFE'),
            combo5: buildCardbackConfig('./cardback/combo5.webp', 'ARC_CYAN', 'rgba(40, 220, 255, 0.95)', 'ARC'),
            speed18: buildCardbackConfig('./cardback/speed18.webp', 'ARC_GREEN', 'rgba(120, 190, 255, 0.9)', 'ARC'),
            ironwill: buildCardbackConfig('./cardback/ironwill.webp', 'FORGE_STEEL', 'rgba(200, 210, 230, 0.85)', 'FORGE'),
            suitcollector: buildCardbackConfig('./cardback/suitcollector.webp', 'LIFE_SUIT', 'rgba(255, 215, 0, 0.9)', 'LIFE'),
            luckydraw: buildCardbackConfig('./cardback/luckydraw.webp', 'VOID_DARK', 'rgba(218, 165, 32, 0.9)', 'VOID'),
            fullsweep: buildCardbackConfig('./cardback/fullsweep.webp', 'FORGE_ROYAL', 'rgba(80, 255, 130, 0.85)', 'FORGE'),
            dailyregular: buildCardbackConfig('./cardback/dailyregular.webp', 'LIFE_STELLAR', 'rgba(255, 200, 80, 0.9)', 'LIFE'),
            chainreaction: buildCardbackConfig('./cardback/chainreaction.webp', 'ARC_CYAN', 'rgba(120, 190, 255, 0.95)', 'ARC'),
            // Extreme Challenge rewards — themed to match the cardback art
            shilian:  buildCardbackConfig('./cardback/shilian.webp',  'FORGE_STEEL',  'rgba(192, 192, 192, 0.85)', 'FORGE'),
            tianzhu:  buildCardbackConfig('./cardback/tianzhu.webp',  'ARC_CYAN',     'rgba(160, 200, 232, 0.9)',  'ARC'),
            xingbao:  buildCardbackConfig('./cardback/xingbao.webp',  'EMBER_BRIGHT', 'rgba(255, 170, 68, 0.95)',  'FORGE'),
            lunhui:   buildCardbackConfig('./cardback/lunhui.webp',   'LIFE_FOREST',  'rgba(136, 221, 170, 0.9)',  'LIFE'),
        ...
        let activeEffectThemeId = 'crystal';
        ...
        const EFFECT_THEMES = [
            ...
            { id: 'arc',     particleTheme: 'ARC_CYAN',     miiProfile: 'ARC',     glowColor: 'rgba(40, 220, 255, 0.95)', nameEN: 'Arc',          nameZH: '弧光',     priceCoins: 80,   shopVisible: true },
            { id: 'life',    particleTheme: 'LIFE_FOREST',  miiProfile: 'LIFE',    glowColor: 'rgba(60, 220, 80, 0.85)',  nameEN: 'Life',         nameZH: '生命',     priceCoins: 80,   shopVisible: true },
        ...
        function unlockCardBack(id) {
            ...
            if (!owned.cardbacks.includes(id)) { owned.cardbacks.push(id); saveOwnedCosmetics(owned); }
            return true;
        }
        ...
        function applyCardBack(id) {
            ...
            document.documentElement.style.setProperty('--cardback-image', cfg.image);
        ...
        function loadCardBack() {
            ...
            applyEffectTheme(getEquippedEffectThemeId());
        }
        ...
        function saveEquipped(eq) {
            localStorage.setItem(COSMETIC_EQUIPPED_KEY, JSON.stringify(eq));
        }

        function getEquippedEffectThemeId() {
            if (activeEffectThemeId && EFFECT_THEME_REGISTRY[activeEffectThemeId]) return activeEffectThemeId;
            return loadEquipped().effectThemeId || DEFAULT_EFFECT_THEME_ID;
        }

        function migrateCardBackInventory() {
            const MIGRATED_FLAG = 'lucky3-cb-migrated-v1';
            if (localStorage.getItem(MIGRATED_FLAG)) return;
            try {
                const old = JSON.parse(localStorage.getItem(CARD_BACK_UNLOCKED) || '[]');
                if (Array.isArray(old) && old.length > 0) {
                    const owned = loadOwnedCosmetics();
                    old.forEach(id => { if (!owned.cardbacks.includes(id)) owned.cardbacks.push(id); });
        ...
        function migrateEquippedToV2() {
            const MIGRATED_V2 = 'lucky3-equipped-v2';
        ...
        function isOwnedEffectTheme(id) {
            if (id === DEFAULT_EFFECT_THEME_ID) return true;
            return loadOwnedCosmetics().effectThemes.includes(id);
        }

        function buyEffectTheme(id) {
            const et = EFFECT_THEME_REGISTRY[id];
            if (!et || !et.priceCoins) return false;
            if (isOwnedEffectTheme(id)) return false;
            if (loadWallet().coins < et.priceCoins) return false;
            if (!spendCoins(et.priceCoins, `buy_effect_${id}`)) return false;
            const owned = loadOwnedCosmetics();
            if (!owned.effectThemes.includes(id)) owned.effectThemes.push(id);
            saveOwnedCosmetics(owned);
            return true;
        }

        function selectEffectTheme(id) {
            if (!isOwnedEffectTheme(id)) {
                if (EFFECT_THEME_REGISTRY[id]?.priceCoins) showBuyEffectConfirm(id);
                return;
            }
            applyEffectTheme(id);
            renderEffectThemeGrid();
        }

        function showBuyEffectConfirm(id) {
            const et = EFFECT_THEME_REGISTRY[id];
            if (!et) return;
            const isZH = currentLocale === 'zh-Hant';
            const name = isZH ? et.nameZH : et.nameEN;
            const w = loadWallet();
            document.getElementById('buy-effect-confirm-dialog')?.remove();
            const dlg = document.createElement('div');
            dlg.id = 'buy-effect-confirm-dialog';
            dlg.className = 'buy-confirm-dialog';
            dlg.innerHTML = `<div class="buy-confirm-inner">
                <div class="buy-confirm-title">${isZH ? '購買特效主題' : 'Buy Effect Theme'}</div>
                <div class="buy-confirm-name">${name}</div>
                <div class="buy-confirm-price">🪙 ${et.priceCoins}</div>
                <div class="buy-confirm-balance">${isZH ? `目前：${w.coins} 幣` : `Balance: ${w.coins}`}</div>
                <div class="buy-confirm-btns">
                    <button class="buy-confirm-ok" onclick="confirmBuyEffect('${id}')">${isZH ? '確認購買' : 'Buy'}</button>
                    <button class="buy-confirm-cancel" onclick="document.getElementById('buy-effect-confirm-dialog')?.remove()">${isZH ? '取消' : 'Cancel'}</button>
                </div>
            </div>`;
            document.body.appendChild(dlg);
        }

        function confirmBuyEffect(id) {
            document.getElementById('buy-effect-confirm-dialog')?.remove();
            if (buyEffectTheme(id)) {
                applyEffectTheme(id);
                renderEffectThemeGrid();
                renderCoinHud();
                showCoinEarnFx(-(EFFECT_THEME_REGISTRY[id]?.priceCoins || 0), 'spend');
            }
        }

        function renderEffectThemeGrid() {
            const grid = document.getElementById('et-grid');
            if (!grid) return;
            const isZH = currentLocale === 'zh-Hant';
            const w = loadWallet();
            const equippedId = getEquippedEffectThemeId();

            grid.innerHTML = EFFECT_THEMES.map(et => {
                const name = isZH ? et.nameZH : et.nameEN;
                ...
                let badge = '';
                let stateClass = '';
                let clickAttr = `onclick="selectEffectTheme('${et.id}')"`;

                if (equipped) {
                    badge = `<div class="et-badge et-equipped">${isZH ? '裝備中' : 'Equipped'}</div>`;
                    stateClass = 'et-state-equipped';
                } else if (owned) {
                    badge = `<div class="et-badge et-owned">${isZH ? '已擁有' : 'Owned'}</div>`;
                    stateClass = 'et-state-owned';
                } else if (et.priceCoins && canAfford) {
                    badge = `<div class="et-badge et-buyable">🪙 ${et.priceCoins}</div>`;
                    stateClass = 'et-state-buyable';
                } else if (et.priceCoins) {
                    badge = `<div class="et-badge et-unaffordable">🪙 ${et.priceCoins}</div>`;
                    stateClass = 'et-state-unaffordable';
                    clickAttr = '';
                } else {
                    badge = `<div class="et-badge et-free">${isZH ? '免費' : 'Free'}</div>`;
                    stateClass = 'et-state-free';
                }
    ...
    <div class="card-center-suit">${card.suit}</div>`;
        ...
        async function dealOneCard(isChained = false) {
            ...
            if (!isChained) ensurePredictionPicked('deal');
            clearHintHighlight();
        ...
        function showCombo(s) {
            ...
            if (currentChallengeId) updateChallengeHud();
            let tier;
            if      (capturedCombo >= 9) tier = 9;
            else if (capturedCombo >= 8) tier = 8;
            else if (capturedCombo >= 7) tier = 7;
            else if (capturedCombo >= 6) tier = 6;
            else if (capturedCombo >= 5) tier = 5;
            else if (capturedCombo >= 4) tier = 4;
            else if (capturedCombo >= 3) tier = 3;
            else                          tier = 2;
            const majorComboAllowed = tier >= 6 && !comboFocusActive && !shouldMinimizeMotion();
            const useLiteVariant = tier >= 6 && !majorComboAllowed;
            ...
            setTimeout(() => {
                ...
                // ── Tier-based 特效 ──
                if (useLiteVariant) {
                    ParticleSystem.emit('fountain', cx, cy, { count: 8 });
                } else if (tier >= 9) {
                    ParticleSystem.emit('fountain', cx, cy, { count: 45, colorStart: '#ffffff', colorEnd: '#ffd700' });
                    const vig = document.createElement('div');
                    vig.className = 'imperial-vignette';
                    document.body.appendChild(vig);
                    setTimeout(() => vig.remove(), getDelay(2200));
                } else if (tier >= 8) {
                    ParticleSystem.emit('fountain', cx, cy, { count: 32, colorStart: '#fff8e0', colorEnd: '#ffd700' });
                    const vig = document.createElement('div');
                    vig.className = 'golden-vignette';
                    document.body.appendChild(vig);
                    setTimeout(() => vig.remove(), getDelay(1800));
                } else if (tier >= 7) {
                    ParticleSystem.emit('fountain', cx, cy, { count: 24, colorStart: '#fff0c0', colorEnd: '#ffa500' });
                    const vig = document.createElement('div');
                    vig.className = 'golden-vignette';
                    document.body.appendChild(vig);
                    setTimeout(() => vig.remove(), getDelay(1600));
                } else if (tier >= 6) {
                    ParticleSystem.emit('fountain', cx, cy, { count: 18, colorStart: '#fff8e0', colorEnd: '#ffd700' });
                    const vig = document.createElement('div');
                    vig.className = 'golden-vignette';
                    document.body.appendChild(vig);
                ...
                const beastTier = Math.max(2, Math.min(9, capturedCombo));
    ...
    <div class="card-center-suit">${data.suit}</div>`;
        ...
        function createFly(data, rect, options = {}) {
            ...
            if (options.hidden) {
                ...
                f.style.backgroundImage = cfg.image || "url('./cardback/classic.webp')";
        ...
        async function showWinPanel() {
            ...
            overlay.innerHTML = `
                <div class="win-panel">
                    ...
                    <div class="win-coins-earned">+${coinResult.total} 🪙${coinResult.bonus > 0 ? ` <span class="win-coins-bonus">${t('win.coins_bonus', { n: coinResult.bonus })}</span>` : ''}</div>
                    ${_progressHtml}
                    ...
                    ${predictionSuit ? `<p class="win-daily">${predictionMatched ? t('prediction.win_hit', { suit: predictionSuit }) : t('prediction.win_miss', { pick: predictionSuit, actual: winCardSuit || '∅' })}</p>` : ''}
            ...
            if (predictionMatched) {
                ...
                const cy = window.innerHeight / 2;
                setTimeout(() => {
                    const suitColor = SUIT_COLORS[predictionSuit] || '#ffd86d';
                    ParticleSystem.emit('burst', cx, cy + 20, { count: 16, colorStart: suitColor, colorEnd: '#ffe4a2' });
                    showPredictionHitFX(predictionSuit);
                    showAchievementToast(t('prediction.hit_toast_title'), t('prediction.hit_toast_body'));
